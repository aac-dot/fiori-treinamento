sap.ui.define([
    ...
    return BaseController.extend("categories.controller.Object", {
        ...
        onCriar: function () {
            ...
            var sMsgSucesso = this.getView().getModel("i18n").getResourceBundle().getText("msgSuccesso");
        ...
        onSalvar: function () {
            ...
            var sMsgCampoVazio = this.getView().getModel("i18n").getResourceBundle().getText("msgCamposObrigatorios");
            var sMsgSucesso = this.getView().getModel("i18n").getResourceBundle().getText("msgSuccesso");
            var sMsgConfirmarSave = this.getView().getModel("i18n").getResourceBundle().getText("msgConfirmSave");
            ...
            MessageBox.confirm(sMsgConfirmarSave, {
        ...
        onExcluir: function () {
            ...
            var sMsgSucesso = this.getView().getModel("i18n").getResourceBundle().getText("msgSuccesso");
            var msgConfirmDelete = this.getView().getModel("i18n").getResourceBundle().getText("msgConfirmDelete");
